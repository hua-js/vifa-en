...
from m3_worker.pv_query_app import build_reader, create_app as create_query_app
...
def build_manager():
    ...
    def operate(kind, directory):
        subprocess.run([sys.executable, str(project/'m3/deploy/run-pv-manual.py'), '--operation', kind,
