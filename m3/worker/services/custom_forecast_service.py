...
LOGGER = logging.getLogger("m3.worker.custom_forecast")
    ...
    def _execute(self, run_id: str) -> None:
        ...
        try:
            ...
            power_source = {
                ...
                'power_profile_lookback_days': 7,
                'power_profile_day_classes': 'weekday_saturday_sunday',
                'power_profile_aggregation': 'matching_slot_median',
