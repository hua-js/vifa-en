...
from m3.worker.domain import pv_training, pv_backtest
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weather-csv', type=Path, default=ROOT/'m3/data/历史天气数据.csv')
    parser.add_argument('--import-verification', type=Path, default=ROOT/'outputs/m3/contracts/20260909/weather_history_import_verification.json')
