...
deployment = load_module('pv_schema_deployment', M3_ROOT/'deploy/create-pv-forecast-collections.py')
credentials = load_module('pv_shared_credentials', PROJECT_ROOT/'m3_worker/pv_credentials.py')
...
def main():
    ...
    parser.add_argument('--csv', type=Path, default=PROJECT_ROOT/'历史天气数据.csv')
    parser.add_argument('--report', type=Path, default=M3_ROOT/'contracts/weather_history_import_verification.json')
