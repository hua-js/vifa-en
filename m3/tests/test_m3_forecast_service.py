...
from m3.worker.services import forecast_service
from m3.worker.services.forecast_service import (
    ForecastService,
    build_latest_snapshot,
)
from m3.worker.services.station_cache import StationCache
from m3.worker.sinks.forecast_sink import canonical_hash
from m3.tests.m3_test_support import RecordingForecastSink, StationKeyedObservationSource
...
class ForecastServiceTests(unittest.TestCase):
    ...
    def test_es01_refresh_cannot_change_es02_cache_or_forecast(self):
        ...
        with patch(
            "m3.worker.services.forecast_service.select_champion",
    ...
    def test_runtime_mismatch_refuses_service_construction_before_source_io(self):
        ...
        source = source_with_history()
        with patch(
            "m3.worker.services.forecast_service.version", return_value="9.9.9"
        ), self.assertRaises(M3Error) as raised:
    ...
    def test_post_cv_version_drift_cannot_be_overwritten_as_degraded(self):
        ...
        with patch(
            ...
            "m3.worker.services.forecast_service.version",
