...
from m3.worker.services.acceptance_service import (
...
from m3.worker.sinks.forecast_sink import (
    POINT_HASH_FIELDS,
    ForecastSink,
    canonical_hash,
)
from m3.tests.test_m3_nocobase_sink import FakeNocoBase, make_acceptance_records


ROOT = Path(__file__).resolve().parents[2]
CONTRACT_PATH = ROOT / "m3/contracts/nocobase_collections.json"
SMOKE_PATH = ROOT / "m3/tests/fixtures/contracts/latest-smoke-record.json"
GUIDE_PATH = ROOT / "docs/m3/部署说明.md"
