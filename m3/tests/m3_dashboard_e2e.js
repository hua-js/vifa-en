...
function task5Fixtures() {
  const script = [
    ...
    "import json",
    "from m3.tests.test_m3_live_dashboard import STATION_1, STATION_2, STATIONS, GENERATED_AT, station_result",
    "from m3.worker.dashboard_contracts import DashboardEnvelope",
    "from m3.worker.services.live_dashboard_service import DashboardCache, build_dashboard_payload",
