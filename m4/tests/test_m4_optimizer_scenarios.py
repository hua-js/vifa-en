...
import m4.optimizer.service as service_module
from m4.optimizer import M4Optimizer
from m4.optimizer.lexicographic import ProfileSolveResult
from m4.optimizer.validation import ResultValidationError
...
class M4OptimizerScenarioTests(unittest.TestCase):
    ...
    def test_public_failure_statuses_have_empty_outputs_and_stable_versions(self):
        ...
        def optimize_failures():
            ...
            with patch("m4.optimizer.service.solve_profile", side_effect=results):
    ...
    def test_candidate_processing_errors_do_not_stop_later_profiles(self):
        ...
        for stage_name, failure in stages:
            with self.subTest(stage=stage_name):
                ...
                with patch(
                    f"m4.optimizer.service.{stage_name}", side_effect=fail_first
                ):
    ...
    def test_unexpected_candidate_programming_error_is_not_swallowed(self):
        with patch(
            "m4.optimizer.service.calculate_metrics",
