...
from m4.optimizer.solver import RawSolveResult
...
class SolverSelectionTests(unittest.TestCase):
    def implementation(self):
        spec = importlib.util.find_spec('m4.selection.solver_selection')
        self.assertIsNotNone(spec, 'M4 requires a solver decision entry point')
        return importlib.import_module('m4.selection.solver_selection')
