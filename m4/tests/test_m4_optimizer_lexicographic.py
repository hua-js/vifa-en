...
from m4.optimizer.solver import MilpProblem, RawSolveResult
...
class M4OptimizerLexicographicTests(unittest.TestCase):
    ...
    def test_error_with_finite_incumbent_does_not_continue_to_next_layer(self):
        ...
        with patch(
            "m4.optimizer.lexicographic.solve_milp",
    ...
    def test_feasible_layer_keeps_final_status_conservative(self):
        ...
        with patch(
            "m4.optimizer.lexicographic.solve_milp", side_effect=[first, second]
        ):
    ...
    def test_total_time_exhaustion_between_layers_returns_last_incumbent(self):
        ...
        with (
            patch("m4.optimizer.lexicographic.solve_milp", return_value=first) as solve,
            patch(
                "m4.optimizer.lexicographic.monotonic",
    ...
    def test_later_timeout_without_x_returns_last_incumbent(self):
        ...
        with patch(
            "m4.optimizer.lexicographic.solve_milp", side_effect=[first, timeout]
        ):
            result = solve_profile(built, profile, 2.0, 0.0)
    ...
    def test_first_layer_timeout_without_incumbent_returns_no_plan(self):
        ...
        with patch("m4.optimizer.lexicographic.solve_milp", return_value=timeout):
