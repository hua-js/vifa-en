...
```bash
python3 m3/scripts/create-custom-forecast-collections.py
python3 m3/scripts/create-custom-forecast-collections.py --show-payloads
```
...
python3 m3/scripts/create-custom-forecast-collections.py --execute
