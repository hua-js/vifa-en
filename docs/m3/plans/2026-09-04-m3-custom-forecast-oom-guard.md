...
**Files:**
- Modify: `m3/tests/test_m3_custom_load_profiles.py`
- Modify: `m3/tests/test_m3_custom_forecasting.py`
- Modify: `m3/worker/domain/custom_load_profiles.py`
...
```bash
.venv/bin/python -m unittest m3.tests.test_m3_custom_load_profiles.EligibilityTests
```
...
**Files:**
- Modify: `m3/tests/test_m3_custom_forecast_service.py`
- Modify: `m3/worker/services/custom_forecast_service.py`
...
```bash
.venv/bin/python -m unittest m3.tests.test_m3_custom_forecast_service.CustomForecastServiceTests.test_recover_fails_orphaned_running_run_and_schedules_queued_run
```
...
**Files:**
- Verify: `m3/tests/test_m3_custom_load_profiles.py`
- Verify: `m3/tests/test_m3_custom_forecast_service.py`
- Verify: `m3/tests/test_m3_daily_custom_forecast_service.py`
...
```bash
.venv/bin/python -m unittest m3.tests.test_m3_custom_load_profiles m3.tests.test_m3_custom_forecast_service m3.tests.test_m3_daily_custom_forecast_service
```
...
git diff --check
git status --short
git diff -- m3/worker/domain/custom_load_profiles.py m3/worker/services/custom_forecast_service.py m3/tests/test_m3_custom_load_profiles.py m3/tests/test_m3_custom_forecast_service.py
```

- [x] **Step 4: Commit the verified fix**

```bash
git add docs/m3/plans/2026-09-04-m3-custom-forecast-oom-guard.md m3/worker/domain/custom_load_profiles.py m3/worker/services/custom_forecast_service.py m3/tests/test_m3_custom_load_profiles.py m3/tests/test_m3_custom_forecasting.py m3/tests/test_m3_custom_forecast_service.py
