...
**Spec:** `docs/superpowers/specs/2026-09-02-m3-daily-custom-forecast-and-acceptance-query-design.md`
...
**Files:**
- Modify: `m3_worker/services/acceptance_service.py:45-70,426-520,724-825`
- Modify: `tests/test_m3_acceptance_service.py:135-175,760-810,1015-1050`
...
```bash
python -m unittest tests.test_m3_acceptance_service -v
```
...
```bash
git add m3_worker/services/acceptance_service.py tests/test_m3_acceptance_service.py
...
- Modify: `tests/test_m3_collection_contract.py:420-535,650-690,1200-1270,1490-1520`
...
```bash
python -m unittest tests.test_m3_collection_contract -v
```
...
```bash
python -m unittest \
  tests.test_m3_collection_contract \
  tests.test_m3_acceptance_service -v
git diff --check
```
...
```bash
git add m3/contracts/nocobase_collections.json tests/test_m3_collection_contract.py
...
**Files:**
- Modify: `m3_worker/services/custom_forecast_repository.py:225-405`
- Modify: `tests/test_m3_custom_forecast_repository.py:115-220`
- Modify: `m3/contracts/nocobase_collections.json:1290-1332`
- Modify: `tests/test_m3_collection_contract.py:560-620,700-735`
...
```bash
python -m unittest tests.test_m3_custom_forecast_repository -v
```
...
```bash
python -m unittest \
  tests.test_m3_custom_forecast_repository \
  tests.test_m3_collection_contract -v
git diff --check
```
...
git add \
  ...
  tests/test_m3_custom_forecast_repository.py \
  m3/contracts/nocobase_collections.json \
  tests/test_m3_collection_contract.py
...
**Files:**
- Create: `m3_worker/services/daily_custom_forecast_service.py`
- Create: `tests/test_m3_daily_custom_forecast_service.py`
- Modify: `m3_worker/services/__init__.py`
...
```bash
python -m unittest tests.test_m3_daily_custom_forecast_service -v
```
...
```bash
python -m unittest \
  tests.test_m3_daily_custom_forecast_service \
  tests.test_m3_custom_forecast_service \
  tests.test_m3_custom_forecast_repository -v
git diff --check
```
...
```bash
git add \
  m3_worker/services/daily_custom_forecast_service.py \
  m3_worker/services/__init__.py \
  tests/test_m3_daily_custom_forecast_service.py
...
**Files:**
- Modify: `m3_worker/scheduler/runner.py:12-40,55-110,180-260`
- Modify: `tests/test_m3_scheduler.py:15-180`
...
```bash
python -m unittest tests.test_m3_scheduler -v
```
...
```bash
git add m3_worker/scheduler/runner.py tests/test_m3_scheduler.py
...
**Files:**
- Modify: `m3_worker/main.py:20-40,105-245,295-365`
- Modify: `tests/test_m3_worker_api.py:65-125,500-620,610-820`
...
```bash
python -m unittest tests.test_m3_worker_api -v
```
...
```bash
python -m unittest \
  tests.test_m3_worker_api \
  tests.test_m3_scheduler \
  tests.test_m3_daily_custom_forecast_service -v
git diff --check
```
...
```bash
git add m3_worker/main.py tests/test_m3_worker_api.py
...
**Files:**
- Modify: `m3/deploy/production-env/README.md`
- Modify: `tests/test_m3_deployment_artifacts.py`
...
```bash
python -m unittest tests.test_m3_deployment_artifacts -v
```
...
python -m compileall -q m3_worker
...
```bash
git add m3/deploy/production-env/README.md tests/test_m3_deployment_artifacts.py
