...
from m4_settings.pv_on_demand import PreparedInputs, PVService, PVPreparationError
...
class ServiceTests(unittest.TestCase):
    ...
    @patch('m4_settings.pv_on_demand.time.sleep')
    ...
    @patch('m4_settings.pv_on_demand.time.monotonic', side_effect=[0,601])
