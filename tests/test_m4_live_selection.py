...
from m4_settings.candidates import CandidateService, CandidateError
from m4_settings.live_inputs import LiveInputService
from m4_settings.store import SettingsStore, SettingsConflict
from test_m4_live_inputs import Client, Controls, NOW
from test_m4_realtime import configuration
from m4_settings.selection import PolicyPreferences, PolicyStore, LiveSelectionService
    ...
    def test_changed_policy_or_inputs_during_selection_rejected(self):
        ...
        for mutation in [lambda:self.policies.save('station-1',preferences(),expected_revision=0),
            ...
            with self.subTest(mutation=mutation):
                ...
                with patch('m4_settings.selection.select_candidate',side_effect=select_and_change):
