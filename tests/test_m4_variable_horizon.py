...
from m4_settings.live_inputs import LiveInputService, request_from_inputs
from m4_settings.peak_preparation import summarize_peak_preparation
from tests.m4_optimizer_test_support import make_request, make_profiles
...
class VariableHorizonTests(unittest.TestCase):
    ...
    def test_internal_gap_cannot_be_treated_as_95_point_prefix(self):
        ...
        with patch('m4_settings.live_inputs.load_forecast',return_value=fake):
    ...
    def test_95_point_valley_labels_do_not_disable_a_fully_known_overnight_block(self):
        from test_m4_optimizer_early_valley import valley_request
