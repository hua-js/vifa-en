...
from test_pv_operational import training, weather_rows


def service():
    assert importlib.util.find_spec('m3_worker.services.pv_publication') is not None, 'publication service missing'
