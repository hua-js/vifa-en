...
from m3_worker.dashboard_cli import build_dashboard, execute, main
from m3_worker.errors import M3Error
from m3_worker.services.live_dashboard_service import DashboardCache
...
class DashboardCliTests(unittest.TestCase):
    ...
    def test_root_script_is_a_thin_fixed_entrypoint(self):
        content = (ROOT / "m3-forecast-api.py").read_text(encoding="utf-8")
        self.assertIn("from m3_worker.dashboard_cli import main", content)
