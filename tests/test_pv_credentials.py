...
class CredentialTests(unittest.TestCase):
    def read(self,path):
        assert importlib.util.find_spec('m3_worker.pv_credentials'), 'shared credential reader missing'
    ...
    def test_import_query_and_service_reuse_same_0640_file(self):
        from m3_worker.pv_query_app import build_reader
        from m3_worker.pv_service_app import service_token
        with tempfile.TemporaryDirectory() as temp:
