...
from m4_settings.decision_runs import DecisionRunError, DecisionRunManager
...
class DecisionRunTests(unittest.TestCase):
    ...
    def test_per_station_locks_idempotency_and_no_ai_gate(self):
        ...
        with patch('m4_settings.decision_runs.run_chain', side_effect=blocked), \
                patch('m4_settings.decision_runs.Thread', side_effect=thread_factory):
            try:
