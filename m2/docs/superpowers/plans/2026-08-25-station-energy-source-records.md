...
**Spec:** `docs/superpowers/specs/2026-08-25-station-energy-source-access-design.md`
...
**Files:**
- Modify: `docs/superpowers/specs/2026-08-24-station-energy-backend-design.md`
...
After the existing request-contract section in `docs/superpowers/specs/2026-08-24-station-energy-backend-design.md`, add a short subsection containing these exact points:
