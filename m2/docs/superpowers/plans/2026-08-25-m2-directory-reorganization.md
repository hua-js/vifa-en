...
**Spec:** `m2/docs/superpowers/specs/2026-08-25-m2-directory-reorganization-design.md`
...
```text
docs/superpowers/plans/2026-08-24-station-energy-backend.md
docs/superpowers/plans/2026-08-25-station-efficiency-history-bottlenecks.md
docs/superpowers/plans/2026-08-25-station-energy-source-records.md
docs/superpowers/specs/2026-08-24-station-energy-backend-design.md
docs/superpowers/specs/2026-08-25-station-energy-source-access-design.md
...
- Modify: `docs/superpowers/plans/2026-08-25-m3-active-http-forecasting.md`
...
Resolve the HTML as `path.resolve(__dirname, "..", "场站三条能效链路能流图.html")` and invoke the fixture through `m2.tests.station_efficiency_history_test_support`.
...
```sh
rg -n 'from station_energy_|import station_energy_|tests\.station_energy_|tests\.station_efficiency_' m2/tests m3 docs/superpowers/plans/2026-08-25-m3-active-http-forecasting.md
```
